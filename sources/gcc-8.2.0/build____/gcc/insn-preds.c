...
static inline int
x86_64_hilo_int_operand_1 (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
...
static inline int
x86_64_dwzext_immediate_operand_1 (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
...
static inline int
const123_operand_1 (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
...
{
  return ((
#line 1137 "../../gcc/config/i386/predicates.md"
(address_operand (op, VOIDmode))) && (
...
#line 1170 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
{
  return ((
#line 1169 "../../gcc/config/i386/predicates.md"
(address_operand (op, VOIDmode))) && (
...
#line 1206 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1267 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1279 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1335 "../../gcc/config/i386/predicates.md"
...
#line 1350 "../../gcc/config/i386/predicates.md"
{
  machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 1393 "../../gcc/config/i386/predicates.md"
{
  machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
{
  return (
#line 1419 "../../gcc/config/i386/predicates.md"
...
#line 1460 "../../gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == MEM) && (
#line 1472 "../../gcc/config/i386/predicates.md"
...
#line 1477 "../../gcc/config/i386/predicates.md"
{
  unsigned i;
...
#line 1507 "../../gcc/config/i386/predicates.md"
{
...
#line 1530 "../../gcc/config/i386/predicates.md"
...
#line 1535 "../../gcc/config/i386/predicates.md"
{
  rtx op0, op1;
  int swapped;
  HOST_WIDE_INT mask;
...
#line 1571 "../../gcc/config/i386/predicates.md"
{
  rtx op0, op1;
  bool swapped;
  int nunits, elt;
...
#line 1602 "../../gcc/config/i386/predicates.md"
{
...
#line 1650 "../../gcc/config/i386/predicates.md"
{
...
#line 1665 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT val = INTVAL (op);
...
{
  return (register_operand (op, mode)) || (((GET_CODE (op) == CONST_INT) && (
#line 1680 "../../gcc/config/i386/predicates.md"
(op == constm1_rtx))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode)));
}

static inline int
save_multiple_1 (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
#line 1686 "../../gcc/config/i386/predicates.md"
{
...
static inline int
restore_multiple_1 (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
#line 1727 "../../gcc/config/i386/predicates.md"
{
  const unsigned len = XVECLEN (op, 0);
  unsigned i;
...
reg_class_for_constraint_1 (enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_Yd: return TARGET_INTER_UNIT_MOVES_TO_VEC
  ? (TARGET_AVX512DQ
     ? ALL_SSE_REGS
     : (TARGET_SSE4_1 ? SSE_REGS : NO_REGS))
  : NO_REGS;
    case CONSTRAINT_Ye: return TARGET_INTER_UNIT_MOVES_FROM_VEC
  ? (TARGET_AVX512DQ
     ? ALL_SSE_REGS
     : (TARGET_SSE4_1 ? SSE_REGS : NO_REGS))
  : NO_REGS;
  ...
  ? NO_REGS : GENERAL_REGS;
    ...
    case CONSTRAINT_Yh: return TARGET_AVX512F ? MOD4_SSE_REGS : NO_REGS;
    default: break;
    }
  return NO_REGS;
}
...
insn_const_int_ok_for_constraint (HOST_WIDE_INT ival, enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_I:
      return 
#line 251 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 31));

    case CONSTRAINT_J:
      return 
#line 256 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 63));

    case CONSTRAINT_K:
      return 
#line 261 "../../gcc/config/i386/constraints.md"
...
(IN_RANGE (ival, 0, 3));
    ...
    case CONSTRAINT_N:
      return 
#line 279 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 255));
