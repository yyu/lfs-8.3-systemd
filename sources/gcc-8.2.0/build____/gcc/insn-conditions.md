(define_conditions [
  ...
  (-1 "(TARGET_SSE
   && !(MEM_P (operands[1]) && MEM_P (operands[2]))
   && 1 && 1) && (TARGET_SSE2)")
  (-1 "(ix86_match_ccmode (insn, CCZmode)) && (TARGET_AVX512DQ)")
  (-1 "TARGET_AVX2
   && (GET_MODE_NUNITS (V32QImode)
       == GET_MODE_NUNITS (V8SImode))")
  (-1 "TARGET_SSSE3 && 1 && 1
  ...
  (-1 "(TARGET_80387 && TARGET_CMOVE)
   || (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH)")
  (-1 "TARGET_64BIT && TARGET_SSE4_1 && TARGET_INTER_UNIT_MOVES_TO_VEC
   && reload_completed")
  (-1 "TARGET_SSE_MATH && TARGET_AVX512ER")
  ...
  (-1 "TARGET_BMI2")
  (-1 "(TARGET_SSE4_1 && TARGET_INTER_UNIT_MOVES_FROM_VEC
   && reload_completed) && (!TARGET_64BIT)")
  ...
  (-1 "TARGET_80387 && X87_ENABLE_FLOAT (XFmode, DImode)
   ...
   && !TARGET_64BIT && optimize_function_for_speed_p (cfun)
   && reload_completed")
  (-1 "(ix86_match_ccmode (insn, CCZmode)) && (TARGET_AVX512BW)")
  (-1 "TARGET_AVX512F && !(MEM_P (operands[0]) && MEM_P (operands[1]))")
  (-1 "ix86_binary_operator_ok (ROTATE, SImode, operands)
   && (INTVAL (operands[3]) & (GET_MODE_BITSIZE (SImode)-1))
      == GET_MODE_BITSIZE (SImode)-1
  ...
  (-1 "(TARGET_64BIT
   ...
   && ix86_check_no_addr_space (insn)) && (Pmode == SImode)")
  (-1 "TARGET_MPX")
  (-1 "(ix86_match_ccmode (insn, CCZmode)) && (TARGET_AVX512BW && TARGET_64BIT)")
  (-1 "(!TARGET_X32
   && !TARGET_INDIRECT_BRANCH_REGISTER
  ...
  (-1 "(ix86_binary_operator_ok (ASHIFTRT, SImode, operands)
   && (INTVAL (operands[3]) & (GET_MODE_BITSIZE (SImode)-1))
      == GET_MODE_BITSIZE (SImode)-1
   && can_create_pseudo_p ()) && ( 1)")
  (-1 "TARGET_SSE_PARTIAL_REG_DEPENDENCY && epilogue_completed
   && optimize_function_for_speed_p (cfun)
   && (!EXT_REX_SSE_REG_P (operands[0])
       || TARGET_AVX512VL)")
  (-1 "(TARGET_SSE2 && 1 && 1
