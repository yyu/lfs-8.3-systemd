...
#line 215 "../../gcc/config/i386/constraints.md"
...
#line 234 "../../gcc/config/i386/constraints.md"
(TARGET_X32 && Pmode == DImode)) && (GOT_memory_operand (op, mode)));
}
static inline bool
...
satisfies_constraint_BC (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (
#line 243 "../../gcc/config/i386/constraints.md"
(TARGET_SSE)) && ((
...
#line 293 "../../gcc/config/i386/constraints.md"
...
satisfies_constraint_C (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (
#line 298 "../../gcc/config/i386/constraints.md"
(TARGET_SSE)) && ((
#line 299 "../../gcc/config/i386/constraints.md"
...
satisfies_constraint_We (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (x86_64_immediate_operand (op, mode)) && (
#line 318 "../../gcc/config/i386/constraints.md"
...
#line 325 "../../gcc/config/i386/constraints.md"
(GET_MODE (op) != VOIDmode));
}
static inline bool
