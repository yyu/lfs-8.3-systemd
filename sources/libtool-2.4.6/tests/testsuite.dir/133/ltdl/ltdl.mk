...
AM_CPPFLAGS	       += -DLT_CONFIG_H='<$(LT_CONFIG_H)>' \
			  ...
			  -I$(srcdir)/ltdl -Iltdl/libltdl \
			  -I$(srcdir)/ltdl/libltdl
...
BUILT_SOURCES	+= ltdl/libltdl/$(LT_ARGZ_H)
EXTRA_DIST	+= ltdl/libltdl/lt__argz_.h \
		   ltdl/lt__argz.c

# We need the following in order to create an <argz.h> when the system
# doesn't have one that works with the given compiler.
all-local $(lib_OBJECTS): ltdl/libltdl/$(LT_ARGZ_H)
ltdl/libltdl/lt__argz.h: ltdl/libltdl/lt__argz_.h
	$(AM_V_at)$(mkinstalldirs) . ltdl/libltdl
	$(AM_V_GEN)cp $(srcdir)/ltdl/libltdl/lt__argz_.h $@-t
	$(AM_V_at)mv $@-t $@
MOSTLYCLEANFILES += ltdl/libltdl/lt__argz.h \
		    ltdl/libltdl/lt__argz.h-t
