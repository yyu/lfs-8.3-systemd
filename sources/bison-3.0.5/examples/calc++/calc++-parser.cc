...
#line 37 "examples/calc++/calc++-parser.cc" // lalr1.cc:406
...
#line 51 "examples/calc++/calc++-parser.cc" // lalr1.cc:414
// Unqualified %code blocks.
#line 24 "examples/calc++/calc++-parser.yy" // lalr1.cc:415

# include "calc++-driver.hh"

#line 57 "examples/calc++/calc++-parser.cc" // lalr1.cc:415
...
namespace yy {
#line 143 "examples/calc++/calc++-parser.cc" // lalr1.cc:481
  ...
  calcxx_parser::stack_symbol_type::stack_symbol_type (const stack_symbol_type& that)
...
#line 41 "examples/calc++/calc++-parser.yy" // lalr1.cc:635
        { yyoutput << yysym.value.template as< std::string > (); }
#line 337 "examples/calc++/calc++-parser.cc" // lalr1.cc:635
        break;
...
#line 344 "examples/calc++/calc++-parser.cc" // lalr1.cc:635
        break;
...
#line 41 "examples/calc++/calc++-parser.yy" // lalr1.cc:635
        { yyoutput << yysym.value.template as< int > (); }
#line 351 "examples/calc++/calc++-parser.cc" // lalr1.cc:635
        break;
  ...
  void
  calcxx_parser::yypop_ (unsigned n)
  {
    yystack_.pop (n);
  }
  ...
  calcxx_parser::parse ()
  {
    ...
    #line 17 "examples/calc++/calc++-parser.yy" // lalr1.cc:737
{
  // Initialize the initial location.
  yyla.location.begin.filename = yyla.location.end.filename = &driver.file;
}

#line 467 "examples/calc++/calc++-parser.cc" // lalr1.cc:737
      ...
      try
        {
          switch (yyn)
            {
  case 2:
#line 44 "examples/calc++/calc++-parser.yy" // lalr1.cc:856
    { driver.result = yystack_[0].value.as< int > (); }
#line 587 "examples/calc++/calc++-parser.cc" // lalr1.cc:856
    break;

  case 3:
#line 47 "examples/calc++/calc++-parser.yy" // lalr1.cc:856
    {}
#line 593 "examples/calc++/calc++-parser.cc" // lalr1.cc:856
    break;

  case 4:
#line 48 "examples/calc++/calc++-parser.yy" // lalr1.cc:856
    {}
#line 599 "examples/calc++/calc++-parser.cc" // lalr1.cc:856
    break;

  case 5:
#line 51 "examples/calc++/calc++-parser.yy" // lalr1.cc:856
    { driver.variables[yystack_[2].value.as< std::string > ()] = yystack_[0].value.as< int > (); }
#line 605 "examples/calc++/calc++-parser.cc" // lalr1.cc:856
    break;

  case 6:
#line 56 "examples/calc++/calc++-parser.yy" // lalr1.cc:856
    { yylhs.value.as< int > () = yystack_[2].value.as< int > () + yystack_[0].value.as< int > (); }
#line 611 "examples/calc++/calc++-parser.cc" // lalr1.cc:856
    break;

  case 7:
#line 57 "examples/calc++/calc++-parser.yy" // lalr1.cc:856
    { yylhs.value.as< int > () = yystack_[2].value.as< int > () - yystack_[0].value.as< int > (); }
#line 617 "examples/calc++/calc++-parser.cc" // lalr1.cc:856
    break;

  case 8:
#line 58 "examples/calc++/calc++-parser.yy" // lalr1.cc:856
    { yylhs.value.as< int > () = yystack_[2].value.as< int > () * yystack_[0].value.as< int > (); }
#line 623 "examples/calc++/calc++-parser.cc" // lalr1.cc:856
    break;

  case 9:
#line 59 "examples/calc++/calc++-parser.yy" // lalr1.cc:856
    { yylhs.value.as< int > () = yystack_[2].value.as< int > () / yystack_[0].value.as< int > (); }
#line 629 "examples/calc++/calc++-parser.cc" // lalr1.cc:856
    break;

  case 10:
#line 60 "examples/calc++/calc++-parser.yy" // lalr1.cc:856
    { std::swap (yylhs.value.as< int > (), yystack_[1].value.as< int > ()); }
#line 635 "examples/calc++/calc++-parser.cc" // lalr1.cc:856
    break;

  case 11:
#line 61 "examples/calc++/calc++-parser.yy" // lalr1.cc:856
    { yylhs.value.as< int > () = driver.variables[yystack_[0].value.as< std::string > ()]; }
#line 641 "examples/calc++/calc++-parser.cc" // lalr1.cc:856
    break;

  case 12:
#line 62 "examples/calc++/calc++-parser.yy" // lalr1.cc:856
    { std::swap (yylhs.value.as< int > (), yystack_[0].value.as< int > ()); }
#line 647 "examples/calc++/calc++-parser.cc" // lalr1.cc:856
    break;


#line 651 "examples/calc++/calc++-parser.cc" // lalr1.cc:856
            default:
              break;
            }
        }
...
#line 1027 "examples/calc++/calc++-parser.cc" // lalr1.cc:1163
#line 63 "examples/calc++/calc++-parser.yy" // lalr1.cc:1164
