...
(*.[0-9]*)
	...
	if test ! -f /mnt/lfs/sources/ncurses-6.1/man_alias.sed ; then
cat >>/mnt/lfs/sources/ncurses-6.1/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /mnt/lfs/sources/ncurses-6.1/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /mnt/lfs/sources/ncurses-6.1/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /mnt/lfs/sources/ncurses-6.1/man/man_db.renames | gawk '{print $2}'`
	...
	sed	-f /mnt/lfs/sources/ncurses-6.1/man_alias.sed \
		< $i | sed -f /mnt/lfs/sources/ncurses-6.1/edit_man.sed >$TMP
