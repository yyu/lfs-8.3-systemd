...
# 99 "/usr/lib/gcc/x86_64-pc-linux-gnu/8.2.0/include/stdarg.h" 3 4
...
extern __ssize_t tee (int __fdin, int __fdout, size_t __len,
        unsigned int __flags);
# 409 "/usr/include/bits/fcntl-linux.h" 3 4
...
# 34 "grub-core/osdep/basic/init.c"
                  , "");
  bindtextdomain ("grub", "/usr/share/locale");
  textdomain ("grub");
