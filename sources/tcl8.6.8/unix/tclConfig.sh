...
# build directory.
TCL_BUILD_LIB_SPEC='-L/mnt/lfs/sources/tcl8.6.8/unix -ltcl8.6'
...
# compiled.
TCL_SRC_DIR='/mnt/lfs/sources/tcl8.6.8'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/mnt/lfs/sources/tcl8.6.8/unix -ltclstub8.6'
...
TCL_BUILD_STUB_LIB_PATH='/mnt/lfs/sources/tcl8.6.8/unix/libtclstub8.6.a'
