...
typedef enum
{
  TUNABLE_ENUM_NAME(glibc, tune, hwcaps),
  ...
  TUNABLE_ENUM_NAME(glibc, tune, x86_non_temporal_threshold),
  TUNABLE_ENUM_NAME(glibc, tune, x86_shared_cache_size),
  ...
  TUNABLE_ENUM_NAME(glibc, tune, x86_data_cache_size),
...
static tunable_t tunable_list[] attribute_relro = {
  {TUNABLE_NAME_S(glibc, tune, hwcaps), {TUNABLE_TYPE_STRING, 0, 0}, {}, NULL, TUNABLE_SECLEVEL_SXID_ERASE, NULL},
  ...
  {TUNABLE_NAME_S(glibc, tune, x86_shstk), {TUNABLE_TYPE_STRING, 0, 0}, {}, NULL, TUNABLE_SECLEVEL_SXID_ERASE, NULL},
  ...
  {TUNABLE_NAME_S(glibc, tune, x86_ibt), {TUNABLE_TYPE_STRING, 0, 0}, {}, NULL, TUNABLE_SECLEVEL_SXID_ERASE, NULL},
  ...
  {TUNABLE_NAME_S(glibc, tune, x86_non_temporal_threshold), {TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX}, {}, NULL, TUNABLE_SECLEVEL_SXID_ERASE, NULL},
  {TUNABLE_NAME_S(glibc, tune, x86_shared_cache_size), {TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX}, {}, NULL, TUNABLE_SECLEVEL_SXID_ERASE, NULL},
  ...
  {TUNABLE_NAME_S(glibc, tune, x86_data_cache_size), {TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX}, {}, NULL, TUNABLE_SECLEVEL_SXID_ERASE, NULL},
