...
"x86_64-linux-4.15.0-1021-aws" or
	die "Errno architecture (x86_64-linux-4.15.0-1021-aws) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
