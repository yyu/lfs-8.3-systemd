...
XS_EUPXS(XS_ODBM_File_DESTROY)
{
    ...
    {
	ODBM_File	db;
#line 149 "ODBM_File.xs"
	dMY_CXT;
	int i = store_value;
#line 324 "ODBM_File.c"
...
;
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "ODBM_File")) {
	    ...
	    Perl_croak_nocontext("%s: %s is not of type %s",
			...
			"db", "ODBM_File")
;
#line 225 "ODBM_File.xs"
	    DBM_setFilter(db->filter[ix], code);
#line 616 "ODBM_File.c"
    }
    XSRETURN(1);
}
...
#line 85 "ODBM_File.xs"
{
    MY_CXT_INIT;
}

#line 676 "ODBM_File.c"
