...
am_rel_srcdir='.'
am_top_srcdir='/sources/automake-1.16.1'
am_top_builddir='/sources/automake-1.16.1'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/usr/share/automake-1.16/am'
    am_automake_acdir='/usr/share/aclocal-1.16'
    am_bindir='/usr/bin'
    am_datadir='/usr/share'
    am_docdir='/usr/share/doc/automake-1.16.1'
    am_pkgvdatadir='/usr/share/automake-1.16'
    am_scriptdir='/usr/share/automake-1.16'
...
MKDIR_P=${AM_TESTSUITE_MKDIR_P-'/tools/bin/mkdir -p'}
