...
enum opt_code
{
  ...
  OPT_mbionic = 1233,                        /* -mbionic */
  OPT_mbmi = 1234,                           /* -mbmi */
  OPT_mbmi2 = 1235,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1236,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1237,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1238,                    /* -mcet-switch */
  OPT_mcld = 1239,                           /* -mcld */
  OPT_mclflushopt = 1240,                    /* -mclflushopt */
  OPT_mclwb = 1241,                          /* -mclwb */
  OPT_mclzero = 1242,                        /* -mclzero */
  OPT_mcmodel_ = 1243,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1244, */                    /* -mcpu= */
  OPT_mcrc32 = 1245,                         /* -mcrc32 */
  OPT_mcx16 = 1246,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1247,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1248,            /* -mdump-tune-features */
  OPT_mf16c = 1249,                          /* -mf16c */
  OPT_mfancy_math_387 = 1250,                /* -mfancy-math-387 */
  OPT_mfentry = 1251,                        /* -mfentry */
  OPT_mfma = 1252,                           /* -mfma */
  OPT_mfma4 = 1253,                          /* -mfma4 */
  OPT_mforce_drap = 1254,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1255,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1256,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1257,                       /* -mfpmath= */
  OPT_mfsgsbase = 1258,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1259,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1260, */              /* -mfused-madd */
  OPT_mfxsr = 1261,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1262,             /* -mgeneral-regs-only */
  OPT_mgfni = 1263,                          /* -mgfni */
  OPT_mglibc = 1264,                         /* -mglibc */
  OPT_mhard_float = 1265,                    /* -mhard-float */
  OPT_mhle = 1266,                           /* -mhle */
  OPT_miamcu = 1267,                         /* -miamcu */
  OPT_mieee_fp = 1268,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1269,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1270,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1271,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1272,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1273,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1274, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1275,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1276,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1277,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1278,                /* -mlong-double-80 */
  OPT_mlwp = 1279,                           /* -mlwp */
  OPT_mlzcnt = 1280,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1281,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1282,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1283,                  /* -mmitigate-rop */
  OPT_mmmx = 1284,                           /* -mmmx */
  OPT_mmovbe = 1285,                         /* -mmovbe */
  OPT_mmovdir64b = 1286,                     /* -mmovdir64b */
  OPT_mmovdiri = 1287,                       /* -mmovdiri */
  OPT_mmpx = 1288,                           /* -mmpx */
  OPT_mms_bitfields = 1289,                  /* -mms-bitfields */
  OPT_mmusl = 1290,                          /* -mmusl */
  OPT_mmwaitx = 1291,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1292,            /* -mno-align-stringops */
  OPT_mno_default = 1293,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1294,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1295,                  /* -mno-push-args */
  OPT_mno_red_zone = 1296,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1297,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1298,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1299,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1300,                          /* -mpc32 */
  OPT_mpc64 = 1301,                          /* -mpc64 */
  OPT_mpc80 = 1302,                          /* -mpc80 */
  OPT_mpclmul = 1303,                        /* -mpclmul */
  OPT_mpcommit = 1304,                       /* -mpcommit */
  OPT_mpconfig = 1305,                       /* -mpconfig */
  OPT_mpku = 1306,                           /* -mpku */
  OPT_mpopcnt = 1307,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1308, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1309,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1310,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1311,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1312,                        /* -mprfchw */
  OPT_mpush_args = 1313,                     /* -mpush-args */
  OPT_mrdpid = 1314,                         /* -mrdpid */
  OPT_mrdrnd = 1315,                         /* -mrdrnd */
  OPT_mrdseed = 1316,                        /* -mrdseed */
  OPT_mrecip = 1317,                         /* -mrecip */
  OPT_mrecip_ = 1318,                        /* -mrecip= */
  OPT_mrecord_mcount = 1319,                 /* -mrecord-mcount */
  OPT_mred_zone = 1320,                      /* -mred-zone */
  OPT_mregparm_ = 1321,                      /* -mregparm= */
  OPT_mrtd = 1322,                           /* -mrtd */
  OPT_mrtm = 1323,                           /* -mrtm */
  OPT_msahf = 1324,                          /* -msahf */
  OPT_msgx = 1325,                           /* -msgx */
  OPT_msha = 1326,                           /* -msha */
  OPT_mshstk = 1327,                         /* -mshstk */
  OPT_mskip_rax_setup = 1328,                /* -mskip-rax-setup */
  OPT_msoft_float = 1329,                    /* -msoft-float */
  OPT_msse = 1330,                           /* -msse */
  OPT_msse2 = 1331,                          /* -msse2 */
  OPT_msse2avx = 1332,                       /* -msse2avx */
  OPT_msse3 = 1333,                          /* -msse3 */
  OPT_msse4 = 1334,                          /* -msse4 */
  OPT_msse4_1 = 1335,                        /* -msse4.1 */
  OPT_msse4_2 = 1336,                        /* -msse4.2 */
  OPT_msse4a = 1337,                         /* -msse4a */
  /* OPT_msse5 = 1338, */                    /* -msse5 */
  OPT_msseregparm = 1339,                    /* -msseregparm */
  OPT_mssse3 = 1340,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1341,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1342, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1343,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1344, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1345,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1346,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1347,            /* -mstringop-strategy= */
  OPT_mstv = 1348,                           /* -mstv */
  OPT_mtbm = 1349,                           /* -mtbm */
  OPT_mtls_dialect_ = 1350,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1351,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1352,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1353,                         /* -mtune= */
  OPT_muclibc = 1354,                        /* -muclibc */
  OPT_mvaes = 1355,                          /* -mvaes */
  OPT_mveclibabi_ = 1356,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1357,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1358,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1359,                    /* -mvzeroupper */
  OPT_mwbnoinvd = 1360,                      /* -mwbnoinvd */
  OPT_mx32 = 1361,                           /* -mx32 */
  OPT_mxop = 1362,                           /* -mxop */
  OPT_mxsave = 1363,                         /* -mxsave */
  OPT_mxsavec = 1364,                        /* -mxsavec */
  OPT_mxsaveopt = 1365,                      /* -mxsaveopt */
  OPT_mxsaves = 1366,                        /* -mxsaves */
  OPT_n = 1367,                              /* -n */
  OPT_no_canonical_prefixes = 1368,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1369,              /* -no-integrated-cpp */
  OPT_no_pie = 1370,                         /* -no-pie */
  OPT_nocpp = 1371,                          /* -nocpp */
  OPT_nodefaultlibs = 1372,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1373,                   /* -nostartfiles */
  OPT_nostdinc = 1374,                       /* -nostdinc */
  OPT_nostdinc__ = 1375,                     /* -nostdinc++ */
  OPT_nostdlib = 1376,                       /* -nostdlib */
  OPT_o = 1377,                              /* -o */
  OPT_p = 1378,                              /* -p */
  OPT_pass_exit_codes = 1379,                /* -pass-exit-codes */
  /* OPT_pedantic = 1380, */                 /* -pedantic */
  OPT_pedantic_errors = 1381,                /* -pedantic-errors */
  OPT_pg = 1382,                             /* -pg */
  OPT_pie = 1383,                            /* -pie */
  OPT_pipe = 1384,                           /* -pipe */
  OPT_posix = 1385,                          /* -posix */
  OPT_print_file_name_ = 1386,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1387,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1388,          /* -print-multi-directory */
  OPT_print_multi_lib = 1389,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1390,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1391,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1392,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1393,               /* -print-prog-name= */
  OPT_print_search_dirs = 1394,              /* -print-search-dirs */
  OPT_print_sysroot = 1395,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1396,   /* -print-sysroot-headers-suffix */
  ...
  OPT_s = 1403,                              /* -s */
  OPT_save_temps = 1404,                     /* -save-temps */
  OPT_save_temps_ = 1405,                    /* -save-temps= */
  OPT_shared = 1406,                         /* -shared */
  OPT_shared_libgcc = 1407,                  /* -shared-libgcc */
  /* OPT_specs = 1408, */                    /* -specs */
  OPT_specs_ = 1409,                         /* -specs= */
  OPT_static = 1410,                         /* -static */
  OPT_static_libasan = 1411,                 /* -static-libasan */
  OPT_static_libgcc = 1412,                  /* -static-libgcc */
  OPT_static_libgfortran = 1413,             /* -static-libgfortran */
  OPT_static_libgo = 1414,                   /* -static-libgo */
  OPT_static_liblsan = 1415,                 /* -static-liblsan */
  OPT_static_libmpx = 1416,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1417,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1418,               /* -static-libstdc++ */
  OPT_static_libtsan = 1419,                 /* -static-libtsan */
  OPT_static_libubsan = 1420,                /* -static-libubsan */
  OPT_static_pie = 1421,                     /* -static-pie */
  /* OPT_std_c__03 = 1422, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1423, */                /* -std=c++0x */
  OPT_std_c__11 = 1424,                      /* -std=c++11 */
  OPT_std_c__14 = 1425,                      /* -std=c++14 */
  OPT_std_c__17 = 1426,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1427, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1428, */                /* -std=c++1z */
  OPT_std_c__2a = 1429,                      /* -std=c++2a */
  OPT_std_c__98 = 1430,                      /* -std=c++98 */
  OPT_std_c11 = 1431,                        /* -std=c11 */
  OPT_std_c17 = 1432,                        /* -std=c17 */
  /* OPT_std_c18 = 1433, */                  /* -std=c18 */
  /* OPT_std_c1x = 1434, */                  /* -std=c1x */
  /* OPT_std_c89 = 1435, */                  /* -std=c89 */
  OPT_std_c90 = 1436,                        /* -std=c90 */
  OPT_std_c99 = 1437,                        /* -std=c99 */
  /* OPT_std_c9x = 1438, */                  /* -std=c9x */
  OPT_std_f2003 = 1439,                      /* -std=f2003 */
  OPT_std_f2008 = 1440,                      /* -std=f2008 */
  OPT_std_f2008ts = 1441,                    /* -std=f2008ts */
  OPT_std_f2018 = 1442,                      /* -std=f2018 */
  OPT_std_f95 = 1443,                        /* -std=f95 */
  OPT_std_gnu = 1444,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1445, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1446, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1447,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1448,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1449,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1450, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1451, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1452,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1453,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1454,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1455,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1456, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1457, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1458, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1459,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1460,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1461, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1462, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1463,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1464, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1465, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1466, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1467, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1468, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1469,                     /* -std=legacy */
  OPT_symbolic = 1470,                       /* -symbolic */
  OPT_t = 1471,                              /* -t */
  OPT_time = 1472,                           /* -time */
  OPT_time_ = 1473,                          /* -time= */
  OPT_tno_android_cc = 1474,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1475,                 /* -tno-android-ld */
  OPT_traditional = 1476,                    /* -traditional */
  OPT_traditional_cpp = 1477,                /* -traditional-cpp */
  OPT_trigraphs = 1478,                      /* -trigraphs */
  OPT_u = 1479,                              /* -u */
  OPT_undef = 1480,                          /* -undef */
  OPT_v = 1481,                              /* -v */
  OPT_version = 1482,                        /* -version */
  OPT_w = 1483,                              /* -w */
  OPT_wrapper = 1484,                        /* -wrapper */
  OPT_x = 1485,                              /* -x */
  OPT_z = 1486,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
